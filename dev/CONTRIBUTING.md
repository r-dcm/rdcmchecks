...
This outlines how to propose a change to rdcmchecks. For a detailed
discussion on contributing to this and other r-dcm packages, please see
the tidyverse [development contributing
guide](https://rstd.io/tidy-contrib) and [code review
principles](https://code-review.tidyverse.org/), which are also followed
here.
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("r-dcm/dcmdata", fork = TRUE)`.
...
Code of Conduct](https://rdcmchecks.r-dcm.org/dev/CODE_OF_CONDUCT.md).
